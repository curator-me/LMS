...
async function seed() {
  ...
  const courseData = [
    { 
        ...
        materials: [
            { type: "text", title: "Intro to Node.js", content: "Node.js allows running JS on the server. It uses an event-driven, non-blocking I/O model.", order: 1 },
            { type: "text", title: "Understanding MongoDB", content: "MongoDB is a NoSQL database that stores data in JSON-like documents. It's highly scalable and flexible.", order: 2 },
            { type: "text", title: "Building your first API", content: "Express is the most popular framework for Node.js. It simplifies routing and middleware management.", order: 3 }
        ]
    },
    { 
        title: "React Mastery", 
        ...
        materials: [
            { type: "text", title: "React Hooks", content: "Learn about useState, useEffect, and how they manage component lifecycles.", order: 1 },
            { type: "text", title: "Component Architecture", content: "How to structure your React apps effectively using atoms, molecules, and organisms.", order: 2 }
        ]
    },
    { 
        title: "Python for AI", 
        ...
        materials: [
            { type: "text", title: "NumPy Basics", content: "Efficiently handling multi-dimensional arrays with NumPy's powerful library.", order: 1 },
            { type: "text", title: "Intro to Neural Networks", content: "Understanding the biological inspiration and mathematical models behind neural networks.", order: 2 }
        ]
    },
    {
